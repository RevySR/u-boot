...
if __name__ == "__main__":
    ...
    outputfile = ''
    try:
        opts, args = getopt.getopt(sys.argv[1:], 'hi:o:asn', ['ifile=', 'ofile=', 'non-encryption'])
    except getopt.GetoptError:
        print('rsa+noaes.py -i <inputfile> -o <outputfile> -n <non-encryption>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('rsa+noaes.py -i <inputfile> -o <outputfile> -n(non-encryption)')
